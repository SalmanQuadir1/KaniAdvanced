    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.update(loadingToast, {
          render: (
            <div style={{ whiteSpace: 'pre-line' }}>{formattedMessage}</div>
          ),
          type: 'success',
          isLoading: false,
          autoClose: 7000,
                          ...
                          <button
                            ...
                            onClick={async () => {
                              try {
                                ...
                                toast.error(
                                  'Failed to download the sample file.',
                                );
                              }
                            }}
                            className="bg-green-500 mt-4 text-white py-2 px-4 rounded hover:bg-green-600"
                          >
