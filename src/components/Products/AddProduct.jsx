...
const AddProduct = () => {
  ...
  const updateProductId = () => {
    const designValue = vaaluee.design
      ? vaaluee.design.designName
      : 'select Design';
        ...
        >
          {({ setFieldValue, values }) => {
            ...
            useEffect(() => {
              const getSubGroup = async () => {
                try {
                  const response = await fetch(
                    `${GET_PRODUCT_GROUP_SUBGROUP_URL}/${id}`,
                    {
                      method: 'GET',
                      headers: {
              ...
              const getDesignGroup = async () => {
                try {
                  const response = await fetch(
                    `${DELETE_PRODUCT_SUBGROUP_URL}${id}/with-colors`,
                    {
                      method: 'GET',
                      headers: {
                        'Content-Type': 'application/json',
                  ...
                  const designgroupOptions =
                    ...
                    data?.colors?.map((color) => ({
                      ...
                      designGroupObject: color,
                    }));
                  setDesignGroupOptions(designgroupOptions);
                } catch (error) {
                  console.error(error);
                  // toast.error("Failed to fetch Style");
                }
            ...
            useEffect(() => {
              ...
              const getDesign = async () => {
                try {
                  const response = await fetch(
                    `${DESIGNBYPR}/${values?.productGroup?.id}`,
                    {
                      method: 'GET',
                      headers: {
                        'Content-Type': 'application/json',
                ...
                <div className="flex flex-col gap-9">
                  ...
                  <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div className="p-6.5">
                        ...
                        <div className="flex-1 min-w-[300px]">
                          ...
                          <div className="bg-white dark:bg-form-Field">
                            <ReactSelect
                              ...
                              styles={customStyles}
                              isDisabled={
                                !values.productGroup || !subGroupOptions.length
                              } // Disable if no product group is selected
                              className="bg-white dark:bg-form-Field"
                              classNamePrefix="react-select"
                              placeholder="Select Product Group"
                            />
                          ...
                          <div className=" z-20 bg-transparent dark:bg-form-Field">
                            <ReactSelect
                              ...
                              onChange={(option) =>
                                setFieldValue(
                                  'colors',
                                  option ? option.designGroupObject : null,
                                )
                              }
                              options={designGroupOptions}
                            ...
                            <ReactSelect
                              ...
                              value={
                                ...
                                supplierNameOptions?.find(
                                  (option) => option.value === values.supplierr,
                                ) ||
                                null
                              }
                              onChange={(option) => {
                                ...
                                setFieldValue(
                                  'supplierCode',
                                  option
                                    ? option.supplierNameObject?.supplierCode
                                    : '',
                                );
                              }}
                      ...
                      <h1 className="text-center text-xl mt-[50px] mb-[50px]">
                        Costing
                      </h1>
                            ...
                            'Specify Slab Based Rates' ? (
                              ...
                              <div className="flex flex-wrap gap-6">
                                {gstDetails.map((gst, index) => (
                                  <div
                                    key={index}
                                    className="mb-4.5 flex flex-wrap gap-6"
                                  >
