...
const AddProduct = () => {
    ...
    //     warpColors: Yup.string().required("Warp Colors are required"),
    //     weftColors: Yup.string().required("Weft Colors are required"),
    //     finishedWeight: Yup.string().required("Finished Weight is required"),
    //     gstDetails: Yup.string().required("GST Details are required"),
    //     mrp: Yup.number()
    ...
    //         .nullable()
    //         .notRequired()
    //         .positive("GBP Price must be greater than 0"),
    //     euroPrice: Yup.number()
    //         .nullable()
    //         .notRequired()
    //         .positive("Euro Price must be greater than 0"),
    //     rmbPrice: Yup.number()
    //         .nullable()
    //         .notRequired()
    //         .positive("RMB Price must be greater than 0"),
    //     pixAndReed: Yup.string().nullable().notRequired(),
    //     baseColour: Yup.string().nullable().notRequired(),
    //     embroideryColors: Yup.string().nullable().notRequired(),
    //     fabricWeave: Yup.string().nullable().notRequired(),
    //     fabricCode: Yup.string().nullable().notRequired(),
    //     fabricCost: Yup.number()
    //         .nullable()
    //         .notRequired()
    //         .positive("Fabric Cost must be greater than 0"),
    //     embroideryCost: Yup.number()
    //         .nullable()
    //         .notRequired()
    //         .positive("Embroidery Cost must be greater than 0"),
                                            ...
                                            {values.gstDetails === "Applicable" && (
                                                <>
                                                    ...
                                                    <div className="flex-1 min-w-[300px]">
                                                        ...
                                                        />
                                                          <ErrorMessage name="hsnCodes" component="div" className="text-red-600 text-sm" />
                                                ...
                                                <div className="mb-4.5 flex flex-wrap gap-6">
                                                    <div className="flex-1 min-w-[300px]">
                                                        ...
                                                        <Field
                                                            name='dyeingCost'
                                                            type="text"
                                                            placeholder="Enter Deyeing Cost"
                                                            className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-Field dark:text-white dark:focus:border-primary"
                                                        />
                                                    </div>
                                                    <div className="flex-1 min-w-[300px]">
                                                ...
                                                <div className="mb-4.5 flex flex-wrap gap-6">
                                                    ...
                                                    <div className="flex-1 min-w-[300px]">
                                                        ...
                                                        <Field
                                                            name='fabricCode'
                                                            type="text"
                                                            placeholder="Enter Embrodery Cost"
                                                            className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-Field dark:text-white dark:focus:border-primary"
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mb-4.5 flex flex-wrap gap-6">
                                                    ...
                                                    <div className="flex-1 min-w-[300px]">
                                                        ...
                                                        <Field
                                                            name="patternColor"
                                                            type="text"
                                                            placeholder="Enter Pattern Colors"
                                                            className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-Field dark:text-white dark:focus:border-primary"
                                                        />
                                                    </div>
                                                </div>
