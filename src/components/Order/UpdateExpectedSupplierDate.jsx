...
import { GET_PRODUCTBYID_URL, GET_ORDERBYID_URL, UPDATE_ORDER_URL, VIEW_ORDER_PRODUCT, UPDATE_ORDERPRODUCT_ALL, UPDATE_ISSUECHALLAN, VIEW_ORDERPRODUCT_ALL, UPDATE_CHALLAN, UPDATE_EXPECTEDDATE } from '../../Constants/utils';
...
const UpdateExpectedSupplierDate = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    const formattedValues = {
      updatedExpectedDate:values?.updatedExpectedDate
    }
    console.log(formattedValues, "gigigig");

    try {
      const url = `${UPDATE_EXPECTEDDATE}/${id}`;
      const method = "PUT";
      ...
      const data = await response.json();
      if (response.ok) {
        toast.success(`Supplier Expected Date Updated  successfully`);
        navigate("/order/supplierExpectdateUpdate")
                ...
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                  ...
                  <div className="p-6.5">
                    ...
                    <div className="flex flex-wrap gap-3 mt-5">
                      ...
                      <div className="flex-1 min-w-[200px]">
                        <label className="mb-2.5 block text-black dark:text-white">New Expected Date</label>
                        <Field
...
export default UpdateExpectedSupplierDate;
