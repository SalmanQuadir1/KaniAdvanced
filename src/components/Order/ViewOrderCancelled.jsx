...
import { DELETE_ORDER_URL, VIEW_ALL_ORDERS, VIEW_APPROVED_ORDERS, VIEW_CANCELLED_ORDERS, VIEW_CREATED_ORDERS, VIEW_PARTIALLYAPPROVED_ORDERS } from "../../Constants/utils";
...
const ViewOrderCancelled = () => {
    ...
    const getOrder = async (page, filters = {}) => {
        ...
        try {
            const response = await fetch(`${VIEW_CANCELLED_ORDERS}?page=${page || 1}`, {
            ...
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">Cancelled Orders</h2>
...
export default ViewOrderCancelled
