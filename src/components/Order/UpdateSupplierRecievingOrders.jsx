...
import { GET_PRODUCTBYID_URL, GET_ORDERBYID_URL, UPDATE_ORDER_URL, VIEW_ORDER_PRODUCT, UPDATE_ORDERPRODUCT_ALL, UPDATE_ISSUECHALLAN, VIEW_ORDERPRODUCT_ALL, UPDATE_CHALLAN } from '../../Constants/utils';
...
const UpdateSupplierRecievingOrders = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    //     navigate("/orderlist/UpdateChallan")
...
export default UpdateSupplierRecievingOrders;
