...
import { DELETE_ORDER_URL, VIEW_ALL_ORDERS, VIEW_CREATED_ORDERS, VIEW_FORCEDCLOSURE_ORDERS, VIEW_PARTIALLYCREATED_ORDERS, VIEW_PARTIALLYPENDING_ORDERS } from "../../Constants/utils";
...
const ViewOrderForcedClosure = () => {
    ...
    const getOrder = async (page, filters = {}) => {
        ...
        try {
            const response = await fetch(`${VIEW_FORCEDCLOSURE_ORDERS}?page=${page || 1}`, {
            ...
            <tr key={index} className='bg-white dark:bg-slate-700 dark:text-white'>
                ...
                <td className="px-5 py-5 border-b border-gray-200 text-sm">
                    <p className="flex text-gray-900 whitespace-no-wrap">
                        <FiEdit size={17} className='text-teal-500 hover:text-teal-700 mx-2' onClick={() => navigate(`/Order/updateorderForcedClosure/${item?.id}`)} title='Edit Order' />  |
            ...
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">Forced Closure Orders</h2>
...
export default ViewOrderForcedClosure
