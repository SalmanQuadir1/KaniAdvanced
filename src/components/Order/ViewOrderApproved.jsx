...
const ViewOrderApproved = () => {
    ...
    if (productSearchTerm) {
      ...
      filteredProducts = allProducts.filter(prod => {
        ...
        if (typeof prod === 'string') {
          ...
          // If product is an object, search in productId or productDescription
          const prodId = prod.productId || prod.id || '';
          const prodDesc = prod.productDescription || '';
          return prodId.toLowerCase().includes(searchLower) || 
                 prodDesc.toLowerCase().includes(searchLower);
        }
        return false;
      });
    }
  ...
  const getProductId = (product) => {
    ...
    if (typeof product === 'object') {
      return product.productId || product.id || JSON.stringify(product);
    }
    return '';
  };
