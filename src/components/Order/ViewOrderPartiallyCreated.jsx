...
const ViewOrderPartiallyCreated = () => {
            ...
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">Partially Approved By Production Orders</h2>
...
export default ViewOrderPartiallyCreated
