...
import { ADD_CUSTOMER_URL, BASE_URL, GETPRODUCTBYSUPPLIER, GETPRODUCTS, GET_INVENTORYLOCATION, GET_VoucherNos_URL, customStyles as createCustomStyles } from '../../../Constants/utils';
...
const CreateVoucher = () => {
    ...
    const courrierLedgerIds = Ledger.filter(ledg =>
    ...
    const handleOrderSelect = async (option) => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/order/order-products/by-order-ids?orderIds=${option}`, {
                method: "GET",
                headers: {
                ...
                >
                    {({ isSubmitting, setFieldValue, values }) => {
                        ...
                        const determineGSTLedgers = (Vouchers, custAddress, isExport, newShippingState, values) => {
                            ...
                            console.log(defGstRegist, typeOfVoucher, "1111111111111111111111111");
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            ...
                                                            <span className="font-medium text-black dark:text-white">
                                                                ...
                                                                <span className='text-red-600'> Important To Check These Ledgers Before Submit</span>
                                                            </span>
