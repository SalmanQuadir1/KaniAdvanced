...
import { GET_VoucherEntriessearch_URL, GET_Vouchersearch_URL, UPDATETOGGLE_Voucher_URL, VIEW_STOCKJOURNALL_URL } from "../../../Constants/utils";
...
useEffect(() => {
        ...
        const getVoucher = async (page = 1) => {
    
    
            try {
                const response = await fetch(`${VIEW_STOCKJOURNALL_URL}`, {
                    method: "GET",
                    headers: {
