...
const AddBulkSupplier = () => {
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Supplier / Excel Upload For Bulk Add Supplier" />
            <div className="container mx-auto px-4 mb-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className="flex justify-between">
                        <h2 className="text-xl font-semibold leading-tight">Excel Upload For Bulk Add Supplier</h2>
                        <p className="inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium bg-success text-success dark:bg-white dark:text-slate-800">
                            Excel Upload For Bulk Add Supplier
                        </p>
                    </div>
                                    ...
                                    <div className="mb-4.5 flex flex-wrap gap-6 mt-12">
                                        ...
                                        <div className="flex-1 min-w-[300px]">
                                            <button
                                                ...
                                                onClick={async () => {
                                                    try {
                                                        const apiEndpoints = `${BASE_URL}/uploadExcel/downloadSampleExcelSupplier`;
                                                        ...
                                                        link.setAttribute('download', 'SupplierSample.xlsx'); // You can customize the filename here
                                            ...
                                            >
                                                Download Sample File For Bulk Add Supplier
                                            </button>
...
export default AddBulkSupplier;
