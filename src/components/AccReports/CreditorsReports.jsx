...
const CreditorsReports = () => {
    ...
    const handlegenerateCsv = async (values) => {
        ...
        try {
            const response = await fetch(`${DOWNLOADACCCSV_REPORT}?fromDate=${values.fromDate}&toDate=${values.toDate}&groupName=${filters.groupName}`, {
                method: "GET",
                headers: {
            ...
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">Creditors Report</h2>
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        <div>
                                            ...
                                            <button
                                                ...
                                                className="flex  mb-4 md:w-[280px] w-[220px] md:h-[37px] h-[40px] pt-2 rounded-lg justify-center  bg-primary md:p-2.5 font-medium md:text-sm text-gray hover:bg-opacity-90"
                                            >
                                                Generate Report (csv)
                                            </button>
                                        </div>
