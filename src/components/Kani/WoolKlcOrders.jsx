...
import {GET_WOOL_KLC_ORDERS_URL, GET_IMAGE } from "../../Constants/utils";
...
const WoolKlcOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_WOOL_KLC_ORDERS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_WOOL_KLC_ORDERS_URL}`;
      ...
      apiUrl = `${GET_WOOL_KLC_ORDERS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_WOOL_KLC_ORDERS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
