...
import {GET_WHOLESALE_CLIENTORDERS_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const WholesaleClientOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_WHOLESALE_CLIENTORDERS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_WHOLESALE_CLIENTORDERS_URL}`;
      ...
      apiUrl = `${GET_WHOLESALE_CLIENTORDERS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_WHOLESALE_CLIENTORDERS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
...
export default WholesaleClientOrders;