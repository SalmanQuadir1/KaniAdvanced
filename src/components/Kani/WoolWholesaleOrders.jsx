...
import {GET_WOOL_WHOLESALE_ORDERS_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const WoolWholesaleOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_WOOL_WHOLESALE_ORDERS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_WOOL_WHOLESALE_ORDERS_URL}`;
      ...
      apiUrl = `${GET_WOOL_WHOLESALE_ORDERS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_WOOL_WHOLESALE_ORDERS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
...
export default WoolWholesaleOrders;