...
import {GET_SAREE_Retail_URL, GET_IMAGE } from "../../Constants/utils";
...
const SareeRetail = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_SAREE_Retail_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_SAREE_Retail_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_SAREE_Retail_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
