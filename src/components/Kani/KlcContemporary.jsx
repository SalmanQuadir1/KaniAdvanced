...
import { GET_KLC_CONTEMPORARY_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const KlcContemporary = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_KLC_CONTEMPORARY_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_KLC_CONTEMPORARY_URL}`;
      ...
      apiUrl = `${GET_KLC_CONTEMPORARY_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_KLC_CONTEMPORARY_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName=" Klc Orders" />
...
export default KlcContemporary;