...
import {GET_CONTWOOL_KLC_URL, GET_IMAGE } from "../../Constants/utils";
...
const ContWoolKlc = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_CONTWOOL_KLC_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_CONTWOOL_KLC_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_CONTWOOL_KLC_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
