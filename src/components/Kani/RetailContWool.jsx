...
import {GET_CONTWOOL_RETAIL_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const RetailContWool = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_CONTWOOL_RETAIL_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_CONTWOOL_RETAIL_URL}`;
      ...
      apiUrl = `${GET_CONTWOOL_RETAIL_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_CONTWOOL_RETAIL_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
