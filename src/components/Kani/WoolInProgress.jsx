...
import { DELETE_ORDER_URL, GET_WOOL_INPROGRESS_ORDERS_URL } from "../../Constants/utils";
...
const WoolInProgress = () => {
   ...
   const getOrder = async (page, filters = {}) => {
    ...
    try {
        ...
        const url = `${GET_WOOL_INPROGRESS_ORDERS_URL}?${queryParams}`;
        ...
        if (data?.content && data.content.length > 0) {
            ...
            console.log("No Wool Embroidery orders found on this page");
            setOrder([]);
        }
            ...
            return (
                <tr className='bg-white dark:bg-slate-700 dark:text-white'>
                    <td colSpan="6" className="px-5 py-5 border-b border-gray-200 text-sm">
                        <p className="text-gray-900 whitespace-no-wrap text-center">No Wool Embroidery Order Found</p>
                    </td>
                </tr>
            );
        }
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Wool Embroidery In Progress Orders" />
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">Wool Embroidery IN PROGRESS ORDERS</h2>
                    </div>
