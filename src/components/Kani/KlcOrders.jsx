...
import {GET_KLCORDERS_URL, GET_IMAGE } from "../../Constants/utils";
...
const KlcOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_KLCORDERS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_KLCORDERS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_KLCORDERS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
