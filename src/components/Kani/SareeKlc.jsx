...
import {GET_SAREE_KLC_URL, GET_IMAGE } from "../../Constants/utils";
...
const SareeKlc = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_SAREE_KLC_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_SAREE_KLC_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_SAREE_KLC_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
