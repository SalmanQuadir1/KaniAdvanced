...
import { GET_PASHMINA_URL, GET_IMAGE } from "../../Constants/utils"; // Changed here
...
const EmbroideryOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_PASHMINA_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`; // Changed here
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_PASHMINA_URL}`; // Changed here
      ...
      apiUrl = `${GET_PASHMINA_URL}?size=${pagination.itemsPerPage}`; // Changed here
      ...
      apiUrl = `${GET_PASHMINA_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`; // Changed here
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Pashmina Embroidery Orders" />
