...
import {GET_SAREE_WHOLESALE_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const SareeWholesale = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_SAREE_WHOLESALE_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_SAREE_WHOLESALE_URL}`;
      ...
      apiUrl = `${GET_SAREE_WHOLESALE_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_SAREE_WHOLESALE_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
