...
import {GET_KLC_PAPIERMACHE_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const KlcPapierMache = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_KLC_PAPIERMACHE_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_KLC_PAPIERMACHE_URL}`;
      ...
      apiUrl = `${GET_KLC_PAPIERMACHE_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_KLC_PAPIERMACHE_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
