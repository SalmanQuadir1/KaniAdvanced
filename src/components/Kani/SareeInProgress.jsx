...
import { DELETE_ORDER_URL, GET_SAREE_INPROGRESS_URL } from "../../Constants/utils";
...
const SareeInProgress = () => {
   ...
   const getOrder = async (page, filters = {}) => {
    ...
    try {
        ...
        const url = `${GET_SAREE_INPROGRESS_URL}?${queryParams}`;
        ...
        if (data?.content && data.content.length > 0) {
            ...
            console.log("No Saree orders found on this page");
            setOrder([]);
        }
            ...
            return (
                <tr className='bg-white dark:bg-slate-700 dark:text-white'>
                    <td colSpan="6" className="px-5 py-5 border-b border-gray-200 text-sm">
                        <p className="text-gray-900 whitespace-no-wrap text-center">No Saree Order Found</p>
                    </td>
                </tr>
            );
        }
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Contemporary Saree In Progress Orders" />
            <div className="container mx-auto px-4 sm:px-8 bg-white dark:bg-slate-800">
                <div className="pt-5">
                    <div className='flex justify-between'>
                        <h2 className="text-xl font-semibold leading-tight">CONTEMPORARY SAREE IN PROGRESS ORDERS</h2>
                    </div>
...
export default SareeInProgress