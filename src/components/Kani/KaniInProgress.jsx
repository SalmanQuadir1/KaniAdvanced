...
import { DELETE_ORDER_URL, VIEW_APPROVED_KANI_ORDERS } from "../../Constants/utils";
...
const KaniInProgress = () => {
   ...
   const getOrder = async (page, filters = {}) => {
    ...
    try {
        ...
        const url = `${VIEW_APPROVED_KANI_ORDERS}?${queryParams}`;
