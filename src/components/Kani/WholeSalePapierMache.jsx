...
import {GET_WHOLESALE_PAPIERMACGE_URL, GET_IMAGE } from "../../Constants/utils";
...
const WholeSalePapierMache = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_WHOLESALE_PAPIERMACGE_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_WHOLESALE_PAPIERMACGE_URL}`;
      ...
      apiUrl = `${GET_WHOLESALE_PAPIERMACGE_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_WHOLESALE_PAPIERMACGE_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
