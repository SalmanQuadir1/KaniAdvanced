...
const KaniSection = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Kani Section" />

      {/* Simple Cards */}
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {kaniModeCards.map((card, index) => {
          // Check if this is the current page (Kani Section)
          const isCurrentPage = card.title === "Kani Section";
