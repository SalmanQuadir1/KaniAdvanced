...
import { DELETE_ORDER_URL, GET_INPROGRESS_PAPERMACHE_ORDERS_URL } from "../../Constants/utils";
...
const PapierMacheInProgress = () => {
   ...
   const getOrder = async (page, filters = {}) => {
    ...
    try {
        ...
        const url = `${GET_INPROGRESS_PAPERMACHE_ORDERS_URL}?${queryParams}`;
...
export default PapierMacheInProgress