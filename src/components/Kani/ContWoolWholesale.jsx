...
import {GET_CONTWOOL_WS_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const ContWoolWholesale = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_CONTWOOL_WS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_CONTWOOL_WS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_CONTWOOL_WS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
...
export default ContWoolWholesale;