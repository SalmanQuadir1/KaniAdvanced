...
import {GET_Kani_CLIENTORDERS_URL, GET_IMAGE } from "../../Constants/utils";
import { FiEdit } from "react-icons/fi";
import { useNavigate } from 'react-router-dom';

const KaniClientOrders = () => {
  ...
  const fetchKaniOrders = async () => {
    ...
    try {
      ...
      apiUrl = `${GET_Kani_CLIENTORDERS_URL}?page=${pagination.currentPage}&size=${pagination.itemsPerPage}`;
  ...
  const fetchKaniOrdersAlternative = async () => {
    try {
      ...
      apiUrl = `${GET_Kani_CLIENTORDERS_URL}`;
      ...
      apiUrl = `${GET_Kani_CLIENTORDERS_URL}?size=${pagination.itemsPerPage}`;
      ...
      apiUrl = `${GET_Kani_CLIENTORDERS_URL}?page=${pageOneBased}&size=${pagination.itemsPerPage}`;
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Kani Client Orders" />
...
export default KaniClientOrders;